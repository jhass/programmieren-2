package de.fhh.pr2.common.u.b3;
...
public class CalendarMain {
	public static void main(String[] args) {
		...
		Calendar budCal = Calendar.getInstance(TimeZone.getTimeZone("Asia/Bangkok"),
											   new Locale("th", "TH"));
		localCal.set(2009, 11, 24, 10, 30, 0);
		budCal.setTime(localCal.getTime());
		DateFormat df = DateFormat.getDateTimeInstance(DateFormat.FULL, DateFormat.LONG, new Locale("de", "DE"));
